...
### 获取请求头 @RequestHeader
![](\images\posts\java\framework\spring-mvc\02\requestHeader.png)
...
测试<br>
![](\images\posts\java\framework\spring-mvc\02\user.png)
...
![](\images\posts\java\framework\spring-mvc\02\BindingAwareModelMap.png)
...
前端页面需要将错误信息显示出来。<br>
![](\images\posts\java\framework\spring-mvc\02\login.png)<br>
从 request 作用域中读取。
```jsp
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<html>
